...
router.get("/drinks", async (req: Request, res: Response) => {
  try {
    ...
    if (sort && typeof sort === "string") {
      const orderItem: sequelize.OrderItem = desc === "true" ? [sort, "DESC"] : sort;
...
router.put("/drinks/:drinkId/reviews/:reviewId", async (req: Request, res: Response) => {
  try {
...
router.delete("/drinks/:drinkId/reviews/:reviewId", async (req: Request, res: Response) => {
  try {
    const reviewId = req.params["reviewId"];
...
router.post("/drinks/:drinkId/pictures", async (req: Request, res: Response) => {
  try {
    const drinkId = req.params["drinkId"];
    const drink = await Drink.findByPk(drinkId);
...
router.delete("/drinks/:drinkId/pictures/:pictureId", async (req: Request, res: Response) => {
  try {
